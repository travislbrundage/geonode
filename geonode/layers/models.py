...
# TODO: Make sure this import actually works
...
class Layer(ResourceBase):
    ...
    def prepare_subtype(self):
        if self.storeType == "dataStore":
            ...
            return "remote"
        # should we return None or '' here?
        # probably don't want to index subtype in this case...
        # but idk if it's possible not to match one of those three
        # try hacking a layer?
        else:
            return None
